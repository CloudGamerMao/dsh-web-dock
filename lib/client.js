// Client half of the dsh-web-dock plugin (v6.31).
//
      ...
      try {
        if (typeof navigator !== 'undefined' && 'serviceWorker' in navigator) {
          navigator.serviceWorker
            ...
            .catch(function (e) {
              console.warn('[dsh-web-dock] eager SW register failed', e)
            })
        }
      } catch (e) {
        console.warn('[dsh-web-dock] eager SW register error', e)
      }
